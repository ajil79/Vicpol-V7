/* Day-to-Day Guide renderer (v7).
   ...
   read-aloud radio calls, a quick reference, and a scenario picker whose jump
...
(function () {
  ...
  function renderGuide() {
    ...
    host.innerHTML =
      ...
      "</div>" +
      // Radio calls — read-aloud accordion
      '<div class="card">' +
        '<h2 style="margin:0 0 4px">Radio calls &amp; the caution</h2>' +
        '<div class="muted" style="margin-bottom:10px">Tap one to open the script here for reading out loud — tap again to close. Fill in the [BRACKETS] as you say it.</div>' +
